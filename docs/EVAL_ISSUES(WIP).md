...
| **6** | [EV-COVERAGE](issues/EV-COVERAGE.md) §4.1（E3） | 🔴 **暂缓（2026-07-31）** | **不接受 ③=67%、不开序 6，待 Platform Architect 出设计/技术理由。** 🔴 **议题已重述**：目标该是**可观测 n ≥ 40**（归因四格的精度 ±26 → ±13 点），**不是语料总量 n=60**；③ 的百分比是副产品不是目标。**不阻塞序 1–5 的提交** |
